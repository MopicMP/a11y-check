...
> Basic accessibility checker for HTML

[![PyPI version](https://badge.fury.io/py/a11y-check.svg)](https://pypi.org/project/a11y-check/)
...
```bash
pip install a11y-check
```

## Quick Start

```python
from a11y_check import check
